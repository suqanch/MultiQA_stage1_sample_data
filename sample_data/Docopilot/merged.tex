...
\begin{figure}[t!]
    ...
    The proposed \modelname-8B shows a notable improvement over baseline models~\cite{InternVL2}, achieving a +19.9\
    \label{fig:teaser}
    \vspace{-3mm}
\end{figure}
...
% ===== table/additional_data_comparison.tex =====
\begin{table*}[t]
\centering
